    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="card card-body">
                <form action="aceptar.php?=<?php echo $_GET['id']; ?>" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="rfc" value="<?php echo $row['rfc']?>" class="form-control" >
                        <label for="estatus">Estatus:</label>
                        <input type="text" name="estatus" value="<?php echo $row['estatus']?>" class="form-control" >
                        
                        <label for="comentario">Comentarios:</label>
                        <input type="text" name="comentario" value="<?php echo $row['comentario']?>"  class="form-control">
                        <input type="submit" class="btn btn-success btn-block" name="btnaceptar" value="Aceptar"/>
                        <?php } ?>
                    </div>
